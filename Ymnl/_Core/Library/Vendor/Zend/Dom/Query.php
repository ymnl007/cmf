...
if (!defined('QUERY_DIR')) {
    define('QUERY_DIR', dirname(__FILE__) . DS);
}

if (!defined('QUERY_INCLUDE_DIR')) {
    define('QUERY_INCLUDE_DIR', QUERY_DIR . 'Query' . DS);
}
/**
 * @see Zend_Dom_Query_Css2Xpath
 */
require_once QUERY_INCLUDE_DIR.'Css2Xpath.php';

/**
 * @see Zend_Dom_Query_Result
 */
require_once QUERY_INCLUDE_DIR.'Result.php';

/** @see Zend_Xml_Security */
require_once QUERY_DIR.'Xml.php';

/** @see Zend_Xml_Exception */
require_once QUERY_DIR.'Xmlexception.php';
...
class Zend_Dom_Query
{
    ...
    public function queryXpath($xpathQuery, $query = null)
    {
        if (null === ($document = $this->getDocument())) {
            require_once QUERY_DIR.'/Exception.php';
